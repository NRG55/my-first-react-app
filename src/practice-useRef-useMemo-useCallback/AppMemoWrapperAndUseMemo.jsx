...
// The main difference between useMemo and useCallback is just the type of value it returns.

// Without useCallback -> const handleClick = () => setCount((prevState) => prevState + 1);
// With useCallback -> const handleClick = useCallback(() => setCount((prevState) => prevState + 1),[]);
// or const memoizedHandleClick = useCallback(handleClick, []);