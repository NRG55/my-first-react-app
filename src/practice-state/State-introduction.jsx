...
// This example doesn’t use React but it gives an idea of how useState works internally:
//--------------------------------------------------
let componentHooks = [];
...
// =================CHALLENGES==================
// Challenge 1 - Complete the gallery: When you press “Next” on the last sculpture, 
...
// hasPrev and hasNext are used both for the returned JSX and inside the event 
// handlers. This handy pattern works because event handler functions “close over”
// any variables declared while rendering
...
export function ExampleFeedbackForm2() {
